...
<body class="hold-transition login-page bg-cyan">
    <div class="login-box">
        <div class="login-logo">
            ...
            {{-- <a href="{{ route('dashboard') }}"><b>Book</b>ly</a> --}}
        </div>
        ...
        <div class="card shadow">
            <div class="card-body login-card-body">
                ...
                {{-- Optional links – hook up later if you want --}}
                <p class="mb-1 mt-3">
                    <a href="#">I forgot my password</a>
                </p>
                <p class="mb-0">
                    <a href="{{ route('register') }}" class="text-center">Sign up as a Customer</a>
                </p>
            </div>
        </div>
    </div>
